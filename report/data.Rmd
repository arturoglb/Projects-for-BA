...
These tables contain information about the overall air quality in 380 cities worldwide from 2015 to 2020. The data set provides a wide variety of information such as min, max, etc. for each air pollutant species (PM2.5, PM10, etc.) as well as meteorological data such as wind and temperature. The years 2019 and 2020 are divided quarterly, PM2.5 and PM10 are measured in $\mu g/x^{3}$. CO is measured in ppm (parts per million), and the others O3, SO2, and NO2 are measured in ppb (parts per billion).
